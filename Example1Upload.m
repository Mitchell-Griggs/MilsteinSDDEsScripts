...
% delays d1 and d2 are on the scheme mesh.
...
for simulation = 1:3
    ...
    samplehvalue = d2;                        % Sample step size to view.
...
%% SIMULATION OF REFERENCE SOLUTION:
    ...
    Xref = zeros(d,length(t)); X0 = phi(0);
    % Initial step:
    ...
    for n = 1:length(t)-1
        ...
        elseif t(n) <= d1 && t(n) > d2 && t(n) <= 2*d2
            Xd1 = phi(t(n)-d1); Xd1d1 = phi(t(n)-d1-d1); Xd2 = Xref(:,n-td2index(1)); Xd2d2 = phi(t(n)-d2-d2);
        elseif t(n) <= d1 && t(n) > 2*d2
            Xd1 = phi(t(n)-d1); Xd1d1 = phi(t(n)-d1-d1); Xd2 = Xref(:,n-td2index(1)); Xd2d2 = Xref(:,n-2*td2index(1)); 
        elseif t(n) > d1 && t(n) <= 2*d1 && t(n) <= d2
            Xd1 = Xref(:,n-td1index(1)); Xd1d1 = phi(t(n)-d1-d1); Xd2 = phi(t(n)-d2); Xd2d2 = phi(t(n)-d2-d2);
        elseif t(n) > d1 && t(n) <= 2*d1 && t(n) > d2 && t(n) <= 2*d2
            Xd1 = Xref(:,n-td1index(1)); Xd1d1 = phi(t(n)-d1-d1); Xd2 = Xref(:,n-td2index(1)); Xd2d2 = phi(t(n)-d2-d2);
        elseif t(n) > d1 && t(n) <= 2*d1 && t(n) > 2*d2
            Xd1 = Xref(:,n-td1index(1)); Xd1d1 = phi(t(n)-d1-d1); Xd2 = Xref(:,n-td2index(1)); Xd2d2 = Xref(:,n-2*td2index(1)); 
        elseif t(n) > 2*d1 && t(n) <= d2
            Xd1 = Xref(:,n-td1index(1)); Xd1d1 = Xref(:,n-2*td1index(1)); Xd2 = phi(t(n)-d2); Xd2d2 = phi(t(n)-d2-d2);
        elseif t(n) > 2*d1 && t(n) > d2 && t(n) <= 2*d2
            Xd1 = Xref(:,n-td1index(1)); Xd1d1 = Xref(:,n-2*td1index(1)); Xd2 = Xref(:,n-td2index(1)); Xd2d2 = phi(t(n)-d2-d2);
    ...
    % ITERATIVE STEPS:
        ...
        for n = 1:N-1
            ...
            if t(n*step) <= d1 && t(n*step) <= d2
                Yd1 = phi(t(n*step)-d1); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = phi(t(n*step)-d2); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) <= d1 && t(n*step) > d2 && t(n*step) <= 2*d2
                Yd1 = phi(t(n*step)-d1); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = EM(:,n-d2schemetimeindex); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) <= d1 && t(n*step) > 2*d2
                Yd1 = phi(t(n*step)-d1); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = EM(:,n-d2schemetimeindex); Yd2d2 = EM(:,n-2*d2schemetimeindex);
            elseif t(n*step) > d1 && t(n*step) <= 2*d1 && t(n*step) <= d2
                Yd1 = EM(:,n-d1schemetimeindex); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = phi(t(n*step)-d2); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) > d1 && t(n*step) <= 2*d1 && t(n*step) > d2 && t(n*step) <= 2*d2
                Yd1 = EM(:,n-d1schemetimeindex); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = EM(:,n-d2schemetimeindex); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) > d1 && t(n*step) <= 2*d1 && t(n*step) > 2*d2
                Yd1 = EM(:,n-d1schemetimeindex); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = EM(:,n-d2schemetimeindex); Yd2d2 = EM(:,n-2*d2schemetimeindex);
            elseif t(n*step) > 2*d1 && t(n*step) <= d2
                Yd1 = EM(:,n-d1schemetimeindex); Yd1d1 = EM(:,n-2*d1schemetimeindex); Yd2 = phi(t(n*step)-d2); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) > 2*d1 && t(n*step) > d2 && t(n*step) <= 2*d2
                Yd1 = EM(:,n-d1schemetimeindex); Yd1d1 = EM(:,n-2*d1schemetimeindex); Yd2 = EM(:,n-d2schemetimeindex); Yd2d2 = phi(t(n*step)-d2-d2);
            ...
            if t(n*step) <= d1+d2
                Yd1d2 = phi(t(n*step)-d1-d2); Yd2d1 = phi(t(n*step)-d1-d2);
            ...
            if t(n*step) <= d1 && t(n*step) <= d2
                Yd1 = phi(t(n*step)-d1); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = phi(t(n*step)-d2); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) <= d1 && t(n*step) > d2 && t(n*step) <= 2*d2
                Yd1 = phi(t(n*step)-d1); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MilSim(:,n-d2schemetimeindex); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) <= d1 && t(n*step) > 2*d2
                Yd1 = phi(t(n*step)-d1); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MilSim(:,n-d2schemetimeindex); Yd2d2 = MilSim(:,n-2*d2schemetimeindex);
            elseif t(n*step) > d1 && t(n*step) <= 2*d1 && t(n*step) <= d2
                Yd1 = MilSim(:,n-d1schemetimeindex); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = phi(t(n*step)-d2); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) > d1 && t(n*step) <= 2*d1 && t(n*step) > d2 && t(n*step) <= 2*d2
                Yd1 = MilSim(:,n-d1schemetimeindex); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MilSim(:,n-d2schemetimeindex); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) > d1 && t(n*step) <= 2*d1 && t(n*step) > 2*d2
                Yd1 = MilSim(:,n-d1schemetimeindex); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MilSim(:,n-d2schemetimeindex); Yd2d2 = MilSim(:,n-2*d2schemetimeindex);
            elseif t(n*step) > 2*d1 && t(n*step) <= d2
                Yd1 = MilSim(:,n-d1schemetimeindex); Yd1d1 = MilSim(:,n-2*d1schemetimeindex); Yd2 = phi(t(n*step)-d2); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) > 2*d1 && t(n*step) > d2 && t(n*step) <= 2*d2
                Yd1 = MilSim(:,n-d1schemetimeindex); Yd1d1 = MilSim(:,n-2*d1schemetimeindex); Yd2 = MilSim(:,n-d2schemetimeindex); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) > 2*d1 && t(n*step) > 2*d2
            ...
            if t(n*step) <= d1 && t(n*step) <= d2
                Yd1 = phi(t(n*step)-d1); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = phi(t(n*step)-d2); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) <= d1 && t(n*step) > d2 && t(n*step) <= 2*d2
                Yd1 = phi(t(n*step)-d1); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MEM(:,n-d2schemetimeindex); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) <= d1 && t(n*step) > 2*d2
                Yd1 = phi(t(n*step)-d1); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MEM(:,n-d2schemetimeindex); Yd2d2 = MEM(:,n-2*d2schemetimeindex);
            elseif t(n*step) > d1 && t(n*step) <= 2*d1 && t(n*step) <= d2
                Yd1 = MEM(:,n-d1schemetimeindex); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = phi(t(n*step)-d2); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) > d1 && t(n*step) <= 2*d1 && t(n*step) > d2 && t(n*step) <= 2*d2
                Yd1 = MEM(:,n-d1schemetimeindex); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MEM(:,n-d2schemetimeindex); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) > d1 && t(n*step) <= 2*d1 && t(n*step) > 2*d2
                Yd1 = MEM(:,n-d1schemetimeindex); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MEM(:,n-d2schemetimeindex); Yd2d2 = MEM(:,n-2*d2schemetimeindex);
            elseif t(n*step) > 2*d1 && t(n*step) <= d2
                Yd1 = MEM(:,n-d1schemetimeindex); Yd1d1 = MEM(:,n-2*d1schemetimeindex); Yd2 = phi(t(n*step)-d2); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) > 2*d1 && t(n*step) > d2 && t(n*step) <= 2*d2
                Yd1 = MEM(:,n-d1schemetimeindex); Yd1d1 = MEM(:,n-2*d1schemetimeindex); Yd2 = MEM(:,n-d2schemetimeindex); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) > 2*d1 && t(n*step) > 2*d2
            ...
            if t(n*step) <= d1 && t(n*step) <= d2
                Yd1 = phi(t(n*step)-d1); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = phi(t(n*step)-d2); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) <= d1 && t(n*step) > d2 && t(n*step) <= 2*d2
                Yd1 = phi(t(n*step)-d1); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MMSim(:,n-d2schemetimeindex); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) <= d1 && t(n*step) > 2*d2
                Yd1 = phi(t(n*step)-d1); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MMSim(:,n-d2schemetimeindex); Yd2d2 = MMSim(:,n-2*d2schemetimeindex);
            elseif t(n*step) > d1 && t(n*step) <= 2*d1 && t(n*step) <= d2
                Yd1 = MMSim(:,n-d1schemetimeindex); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = phi(t(n*step)-d2); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) > d1 && t(n*step) <= 2*d1 && t(n*step) > d2 && t(n*step) <= 2*d2
                Yd1 = MMSim(:,n-d1schemetimeindex); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MMSim(:,n-d2schemetimeindex); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) > d1 && t(n*step) <= 2*d1 && t(n*step) > 2*d2
                Yd1 = MMSim(:,n-d1schemetimeindex); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MMSim(:,n-d2schemetimeindex); Yd2d2 = MMSim(:,n-2*d2schemetimeindex);
            elseif t(n*step) > 2*d1 && t(n*step) <= d2
                Yd1 = MMSim(:,n-d1schemetimeindex); Yd1d1 = MMSim(:,n-2*d1schemetimeindex); Yd2 = phi(t(n*step)-d2); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) > 2*d1 && t(n*step) > d2 && t(n*step) <= 2*d2
                Yd1 = MMSim(:,n-d1schemetimeindex); Yd1d1 = MMSim(:,n-2*d1schemetimeindex); Yd2 = MMSim(:,n-d2schemetimeindex); Yd2d2 = phi(t(n*step)-d2-d2);
            elseif t(n*step) > 2*d1 && t(n*step) > 2*d2
            ...
            if useRefinedMilsteinschemes == 1
                ...
                if t(n*step) <= d1 && t(n*step) <= d2
                    Yd1 = phi(t(n*step)-d1); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = phi(t(n*step)-d2); Yd2d2 = phi(t(n*step)-d2-d2);
                elseif t(n*step) <= d1 && t(n*step) > d2 && t(n*step) <= 2*d2
                    Yd1 = phi(t(n*step)-d1); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MilRef(:,n-d2schemetimeindex); Yd2d2 = phi(t(n*step)-d2-d2);
                elseif t(n*step) <= d1 && t(n*step) > 2*d2
                    Yd1 = phi(t(n*step)-d1); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MilRef(:,n-d2schemetimeindex); Yd2d2 = MilRef(:,n-2*d2schemetimeindex);
                elseif t(n*step) > d1 && t(n*step) <= 2*d1 && t(n*step) <= d2
                    Yd1 = MilRef(:,n-d1schemetimeindex); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = phi(t(n*step)-d2); Yd2d2 = phi(t(n*step)-d2-d2);
                elseif t(n*step) > d1 && t(n*step) <= 2*d1 && t(n*step) > d2 && t(n*step) <= 2*d2
                    Yd1 = MilRef(:,n-d1schemetimeindex); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MilRef(:,n-d2schemetimeindex); Yd2d2 = phi(t(n*step)-d2-d2);
                elseif t(n*step) > d1 && t(n*step) <= 2*d1 && t(n*step) > 2*d2
                    Yd1 = MilRef(:,n-d1schemetimeindex); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MilRef(:,n-d2schemetimeindex); Yd2d2 = MilRef(:,n-2*d2schemetimeindex);
                elseif t(n*step) > 2*d1 && t(n*step) <= d2
                    Yd1 = MilRef(:,n-d1schemetimeindex); Yd1d1 = MilRef(:,n-2*d1schemetimeindex); Yd2 = phi(t(n*step)-d2); Yd2d2 = phi(t(n*step)-d2-d2);
                elseif t(n*step) > 2*d1 && t(n*step) > d2 && t(n*step) <= 2*d2
                    Yd1 = MilRef(:,n-d1schemetimeindex); Yd1d1 = MilRef(:,n-2*d1schemetimeindex); Yd2 = MilRef(:,n-d2schemetimeindex); Yd2d2 = phi(t(n*step)-d2-d2);
                elseif t(n*step) > 2*d1 && t(n*step) > 2*d2
                ...
                if t(n*step) <= d1 && t(n*step) <= d2
                    Yd1 = phi(t(n*step)-d1); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = phi(t(n*step)-d2); Yd2d2 = phi(t(n*step)-d2-d2);
                elseif t(n*step) <= d1 && t(n*step) > d2 && t(n*step) <= 2*d2
                    Yd1 = phi(t(n*step)-d1); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MMRef(:,n-d2schemetimeindex); Yd2d2 = phi(t(n*step)-d2-d2);
                elseif t(n*step) <= d1 && t(n*step) > 2*d2
                    Yd1 = phi(t(n*step)-d1); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MMRef(:,n-d2schemetimeindex); Yd2d2 = MMRef(:,n-2*d2schemetimeindex);
                elseif t(n*step) > d1 && t(n*step) <= 2*d1 && t(n*step) <= d2
                    Yd1 = MMRef(:,n-d1schemetimeindex); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = phi(t(n*step)-d2); Yd2d2 = phi(t(n*step)-d2-d2);
                elseif t(n*step) > d1 && t(n*step) <= 2*d1 && t(n*step) > d2 && t(n*step) <= 2*d2
                    Yd1 = MMRef(:,n-d1schemetimeindex); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MMRef(:,n-d2schemetimeindex); Yd2d2 = phi(t(n*step)-d2-d2);
                elseif t(n*step) > d1 && t(n*step) <= 2*d1 && t(n*step) > 2*d2
                    Yd1 = MMRef(:,n-d1schemetimeindex); Yd1d1 = phi(t(n*step)-d1-d1); Yd2 = MMRef(:,n-d2schemetimeindex); Yd2d2 = MMRef(:,n-2*d2schemetimeindex);
                elseif t(n*step) > 2*d1 && t(n*step) <= d2
                    Yd1 = MMRef(:,n-d1schemetimeindex); Yd1d1 = MMRef(:,n-2*d1schemetimeindex); Yd2 = phi(t(n*step)-d2); Yd2d2 = phi(t(n*step)-d2-d2);
                elseif t(n*step) > 2*d1 && t(n*step) > d2 && t(n*step) <= 2*d2
                    Yd1 = MMRef(:,n-d1schemetimeindex); Yd1d1 = MMRef(:,n-2*d1schemetimeindex); Yd2 = MMRef(:,n-d2schemetimeindex); Yd2d2 = phi(t(n*step)-d2-d2);
                elseif t(n*step) > 2*d1 && t(n*step) > 2*d2
                    Yd1 = MMRef(:,n-d1schemetimeindex); Yd1d1 = MMRef(:,n-2*d1schemetimeindex); Yd2 = MMRef(:,n-d2schemetimeindex); Yd2d2 = MMRef(:,n-2*d2schemetimeindex);
                end
                if t(n*step) <= d1+d2
                    Yd1d2 = phi(t(n*step)-d1-d2); Yd2d1 = phi(t(n*step)-d1-d2);
                elseif t(n*step) > d1+d2
...
if useRefinedMilsteinschemes == 0
    legend('Reference Solution','EM','Milstein (Simple)','MEM','MM (Simple)','Interpreter','latex','FontSize',12,'location','Northwest')
elseif useRefinedMilsteinschemes == 1
    legend('Reference Solution','EM','Milstein (Simple)','Milstein (Refined)','MEM','MM (Simple)','MM (Refined)','Interpreter','latex','FontSize',12,'location','Northwest')
end
...
% if simulation == 1
%     saveas(gcf,'ZExample1Plot.eps','epsc')
% end
...
for Ti = simulation%NO%1:NO
    ...
    elseif simulation == 3
        plot(log(hvalues)/log(2),log10(referenceorderhalf)-0.45,'m-o','Linewidth',1)
        plot(log(hvalues)/log(2),log10(referenceorderone)-1.5,'m-square','Linewidth',1)
    end
    plot(log(hvalues)/log(2),log(MSErrorEM(end,:))/log(10),'r-o','Linewidth',1)
    plot(log(hvalues)/log(2),log(MSErrorMilSim(end,:))/log(10),'-o','color',[1/3,1/3,1],'Linewidth',1)
    if useRefinedMilsteinschemes == 1
        plot(log(hvalues)/log(2),log(MSErrorMilRef(end,:))/log(10),'-square','color',[1/3,1/3,1],'Linewidth',1)
    end
    plot(log(hvalues)/log(2),log(MSErrorMEM(end,:))/log(10),'--*','color',[1,1/2,0],'Linewidth',1)
    plot(log(hvalues)/log(2),log(MSErrorMMSim(end,:))/log(10),'--*','color',[0,2/3,0],'Linewidth',1)
    if useRefinedMilsteinschemes == 1
        plot(log(hvalues)/log(2),log(MSErrorMMRef(end,:))/log(10),'--square','MarkerSize',10,'color',[0,2/3,0],'Linewidth',1)
    end
...
%     end
    ...
    %ylim([log(min([MSErrorMEM(Ti,:),MSErrorEM(Ti,:),MSErrorMMSim(Ti,:)]))/log(10)-3.1,log(max([MSErrorMEM(Ti,:),MSErrorEM(Ti,:),MSErrorMMSim(Ti,:)]))/log(10)+0.3])
    ...
    if saveplots == 1 && simulation == 1 && runs == runstosave
        saveas(gcf,'ZExample1A.eps','epsc')
    end
    if saveplots == 1 && simulation == 2 && runs == runstosave
        legend off
        saveas(gcf,'ZExample1B.eps','epsc')
    end
    if saveplots == 1 && simulation == 3 && runs == runstosave
        legend off
        saveas(gcf,'ZExample1C.eps','epsc')
    end
end
end
