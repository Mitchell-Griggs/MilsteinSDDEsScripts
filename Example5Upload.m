...
tobservations = [1/2,d1,2*d2,T/3,2*T/3,T];
...
for trial = 1:runs
    ...
    if mod(trial,50)==0; disp(['Trial number: ',num2str(trial)]); end
    ...
    % ITERATIVE STEPS:
        ...
        for n = 1:N-1
            ...
            elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && schememesh(n) <= d2
                i1 = find(schememesh <= schememesh(n)-d1,1,'last');
                i2 = 0;
                j1 = 0;
                j2 = 0;
            elseif 2*d1 < schememesh(n) && schememesh(n) <= d2
                i1 = find(schememesh <= schememesh(n)-d1,1,'last');
                i2 = find(schememesh <= schememesh(n)-2*d1,1,'last');
                j1 = 0;
                j2 = 0;
            elseif schememesh(n) <= d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                i1 = 0;
                i2 = 0;
                j1 = find(schememesh <= schememesh(n)-d2,1,'last');
                j2 = 0;
            elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                ...
                j1 = find(schememesh <= schememesh(n)-d2,1,'last');
                j2 = 0;
            elseif 2*d1 < schememesh(n) && d2 < schememesh(n) && schememesh(n) <= 2*d2
                i1 = find(schememesh <= schememesh(n)-d1,1,'last');
                i2 = find(schememesh <= schememesh(n)-2*d1,1,'last');
                j1 = find(schememesh <= schememesh(n)-d2,1,'last');
                j2 = 0;
            elseif schememesh(n) <= d1 && schememesh(n) > 2*d2
                i1 = 0;
                i2 = 0;
                j1 = find(schememesh <= schememesh(n)-d2,1,'last');
                j2 = find(schememesh <= schememesh(n)-2*d2,1,'last');
            elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && schememesh(n) > 2*d2
                i1 = find(schememesh <= schememesh(n)-d1,1,'last');
                i2 = 0;
                j1 = find(schememesh <= schememesh(n)-d2,1,'last');
                j2 = find(schememesh <= schememesh(n)-2*d2,1,'last');
            elseif 2*d1 < schememesh(n) && schememesh(n) > 2*d2
                i1 = find(schememesh <= schememesh(n)-d1,1,'last');
                i2 = find(schememesh <= schememesh(n)-2*d1,1,'last');
                j1 = find(schememesh <= schememesh(n)-d2,1,'last');
                j2 = find(schememesh <= schememesh(n)-2*d2,1,'last');
            ...
            if schememesh(n) <= d1 + d2
                ...
                i1j1 = find(schememesh <= schememesh(n)-d1-d2,1,'last');
            end
            ...
            elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && schememesh(n) <= d2
                Yd1 = EM(:,i1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = phi(schememesh(n)-d2); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif schememesh(n) > 2*d1 && schememesh(n) <= d2
                Yd1 = EM(:,i1); Yd1d1 = EM(:,i2); Yd2 = phi(schememesh(n)-d2); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif schememesh(n) <= d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                Yd1 = phi(schememesh(n)-d1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = EM(:,j1); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                Yd1 = EM(:,i1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = EM(:,j1); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif schememesh(n) > 2*d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                Yd1 = EM(:,i1); Yd1d1 = EM(:,i2); Yd2 = EM(:,j1); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif schememesh(n) <= d1 && 2*d2 < schememesh(n)
                Yd1 = phi(schememesh(n)-d1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = EM(:,j1); Yd2d2 = EM(:,j2); 
            elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && 2*d2 < schememesh(n)
                Yd1 = EM(:,i1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = EM(:,j1); Yd2d2 = EM(:,j2);
            elseif schememesh(n) > 2*d1 && 2*d2 < schememesh(n)
                Yd1 = EM(:,i1); Yd1d1 = EM(:,i2); Yd2 = EM(:,j1); Yd2d2 = EM(:,j2);
            end
            if schememesh(n) <= d1 + d2
            ...
            if schememesh(n) <= d1 && schememesh(n) <= d2
                Yd1 = phi(schememesh(n)-d1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = phi(schememesh(n)-d2); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && schememesh(n) <= d2
                Yd1 = MilSim(:,i1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = phi(schememesh(n)-d2); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif schememesh(n) > 2*d1 && schememesh(n) <= d2
                Yd1 = MilSim(:,i1); Yd1d1 = MilSim(:,i2); Yd2 = phi(schememesh(n)-d2); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif schememesh(n) <= d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                Yd1 = phi(schememesh(n)-d1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MilSim(:,j1); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                Yd1 = MilSim(:,i1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MilSim(:,j1); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif schememesh(n) > 2*d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                Yd1 = MilSim(:,i1); Yd1d1 = MilSim(:,i2); Yd2 = MilSim(:,j1); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif schememesh(n) <= d1 && 2*d2 < schememesh(n)
                Yd1 = phi(schememesh(n)-d1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MilSim(:,j1); Yd2d2 = MilSim(:,j2); 
            elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && 2*d2 < schememesh(n)
                Yd1 = MilSim(:,i1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MilSim(:,j1); Yd2d2 = MilSim(:,j2);
            elseif schememesh(n) > 2*d1 && 2*d2 < schememesh(n)
                Yd1 = MilSim(:,i1); Yd1d1 = MilSim(:,i2); Yd2 = MilSim(:,j1); Yd2d2 = MilSim(:,j2);
            end
            if schememesh(n) <= d1 + d2
                Yd1d2 = phi(schememesh(n)-d1-d2);
            elseif schememesh(n) > d1 + d2
            ...
            if schememesh(n) <= d1 && schememesh(n) <= d2
                Yd1 = phi(schememesh(n)-d1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = phi(schememesh(n)-d2); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && schememesh(n) <= d2
                Yd1 = MEM(:,i1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = phi(schememesh(n)-d2); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif schememesh(n) > 2*d1 && schememesh(n) <= d2
                Yd1 = MEM(:,i1); Yd1d1 = MEM(:,i2); Yd2 = phi(schememesh(n)-d2); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif schememesh(n) <= d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                Yd1 = phi(schememesh(n)-d1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MEM(:,j1); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                Yd1 = MEM(:,i1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MEM(:,j1); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif schememesh(n) > 2*d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                Yd1 = MEM(:,i1); Yd1d1 = MEM(:,i2); Yd2 = MEM(:,j1); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif schememesh(n) <= d1 && 2*d2 < schememesh(n)
                Yd1 = phi(schememesh(n)-d1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MEM(:,j1); Yd2d2 = MEM(:,j2); 
            elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && 2*d2 < schememesh(n)
                Yd1 = MEM(:,i1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MEM(:,j1); Yd2d2 = MEM(:,j2);
            elseif schememesh(n) > 2*d1 && 2*d2 < schememesh(n)
                Yd1 = MEM(:,i1); Yd1d1 = MEM(:,i2); Yd2 = MEM(:,j1); Yd2d2 = MEM(:,j2);
            end
            if schememesh(n) <= d1 + d2
                Yd1d2 = phi(schememesh(n)-d1-d2);
            elseif schememesh(n) > d1 + d2
            ...
            if schememesh(n) <= d1 && schememesh(n) <= d2
                Yd1 = phi(schememesh(n)-d1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = phi(schememesh(n)-d2); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && schememesh(n) <= d2
                Yd1 = MMSim(:,i1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = phi(schememesh(n)-d2); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif schememesh(n) > 2*d1 && schememesh(n) <= d2
                Yd1 = MMSim(:,i1); Yd1d1 = MMSim(:,i2); Yd2 = phi(schememesh(n)-d2); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif schememesh(n) <= d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                Yd1 = phi(schememesh(n)-d1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MMSim(:,j1); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                Yd1 = MMSim(:,i1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MMSim(:,j1); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif schememesh(n) > 2*d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                Yd1 = MMSim(:,i1); Yd1d1 = MMSim(:,i2); Yd2 = MMSim(:,j1); Yd2d2 = phi(schememesh(n)-d2-d2);
            elseif schememesh(n) <= d1 && 2*d2 < schememesh(n)
                Yd1 = phi(schememesh(n)-d1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MMSim(:,j1); Yd2d2 = MMSim(:,j2); 
            elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && 2*d2 < schememesh(n)
                Yd1 = MMSim(:,i1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MMSim(:,j1); Yd2d2 = MMSim(:,j2);
            elseif schememesh(n) > 2*d1 && 2*d2 < schememesh(n)
                Yd1 = MMSim(:,i1); Yd1d1 = MMSim(:,i2); Yd2 = MMSim(:,j1); Yd2d2 = MMSim(:,j2);
            end
            if schememesh(n) <= d1 + d2
                Yd1d2 = phi(schememesh(n)-d1-d2);
            elseif schememesh(n) > d1 + d2
            ...
            % Refined Schemes:
                ...
                if schememesh(n) <= d1 && schememesh(n) <= d2
                    Yd1 = phi(schememesh(n)-d1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = phi(schememesh(n)-d2); Yd2d2 = phi(schememesh(n)-d2-d2);
                elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && schememesh(n) <= d2
                    Yd1 = MilRef(:,i1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = phi(schememesh(n)-d2); Yd2d2 = phi(schememesh(n)-d2-d2);
                elseif schememesh(n) > 2*d1 && schememesh(n) <= d2
                    Yd1 = MilRef(:,i1); Yd1d1 = MilRef(:,i2); Yd2 = phi(schememesh(n)-d2); Yd2d2 = phi(schememesh(n)-d2-d2);
                elseif schememesh(n) <= d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                    Yd1 = phi(schememesh(n)-d1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MilRef(:,j1); Yd2d2 = phi(schememesh(n)-d2-d2);
                elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                    Yd1 = MilRef(:,i1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MilRef(:,j1); Yd2d2 = phi(schememesh(n)-d2-d2);
                elseif schememesh(n) > 2*d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                    Yd1 = MilRef(:,i1); Yd1d1 = MilRef(:,i2); Yd2 = MilRef(:,j1); Yd2d2 = phi(schememesh(n)-d2-d2);
                elseif schememesh(n) <= d1 && 2*d2 < schememesh(n)
                    Yd1 = phi(schememesh(n)-d1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MilRef(:,j1); Yd2d2 = MilRef(:,j2); 
                elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && 2*d2 < schememesh(n)
                    Yd1 = MilRef(:,i1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MilRef(:,j1); Yd2d2 = MilRef(:,j2);
                elseif schememesh(n) > 2*d1 && 2*d2 < schememesh(n)
                    Yd1 = MilRef(:,i1); Yd1d1 = MilRef(:,i2); Yd2 = MilRef(:,j1); Yd2d2 = MilRef(:,j2);
                end
                if schememesh(n) <= d1 + d2
                    Yd1d2 = phi(schememesh(n)-d1-d2);
                elseif schememesh(n) > d1 + d2
                ...
                if schememesh(n) <= d1 && schememesh(n) <= d2
                    Yd1 = phi(schememesh(n)-d1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = phi(schememesh(n)-d2); Yd2d2 = phi(schememesh(n)-d2-d2);
                elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && schememesh(n) <= d2
                    Yd1 = MMRef(:,i1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = phi(schememesh(n)-d2); Yd2d2 = phi(schememesh(n)-d2-d2);
                elseif schememesh(n) > 2*d1 && schememesh(n) <= d2
                    Yd1 = MMRef(:,i1); Yd1d1 = MMRef(:,i2); Yd2 = phi(schememesh(n)-d2); Yd2d2 = phi(schememesh(n)-d2-d2);
                elseif schememesh(n) <= d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                    Yd1 = phi(schememesh(n)-d1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MMRef(:,j1); Yd2d2 = phi(schememesh(n)-d2-d2);
                elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                    Yd1 = MMRef(:,i1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MMRef(:,j1); Yd2d2 = phi(schememesh(n)-d2-d2);
                elseif schememesh(n) > 2*d1 && d2 < schememesh(n) && schememesh(n) <= 2*d2
                    Yd1 = MMRef(:,i1); Yd1d1 = MMRef(:,i2); Yd2 = MMRef(:,j1); Yd2d2 = phi(schememesh(n)-d2-d2);
                elseif schememesh(n) <= d1 && 2*d2 < schememesh(n)
                    Yd1 = phi(schememesh(n)-d1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MMRef(:,j1); Yd2d2 = MMRef(:,j2); 
                elseif d1 < schememesh(n) && schememesh(n) <= 2*d1 && 2*d2 < schememesh(n)
                    Yd1 = MMRef(:,i1); Yd1d1 = phi(schememesh(n)-d1-d1); Yd2 = MMRef(:,j1); Yd2d2 = MMRef(:,j2);
                elseif schememesh(n) > 2*d1 && 2*d2 < schememesh(n)
                    Yd1 = MMRef(:,i1); Yd1d1 = MMRef(:,i2); Yd2 = MMRef(:,j1); Yd2d2 = MMRef(:,j2);
                end
                if schememesh(n) <= d1 + d2
                    Yd1d2 = phi(schememesh(n)-d1-d2);
                elseif schememesh(n) > d1 + d2
...
for Ti = 1:NO
    ...
    if saveplots == 1 && Ti == 1 && runs == runstosave
        ylabel('$\log_{10}\mathrm{MSE}(1/2)$','Interpreter','latex','FontSize',16)
        saveas(gcf,'ZExample3A.eps','epsc')
    elseif saveplots == 1 && Ti == 2 && runs == runstosave
        legend off
        ylabel('$\log_{10}\mathrm{MSE}(\tau_1)$','Interpreter','latex','FontSize',16)
        saveas(gcf,'ZExample3B.eps','epsc')
    elseif saveplots == 1 && Ti == 3 && runs == runstosave
        legend off
        ylabel('$\log_{10}\mathrm{MSE}(2\tau_2)$','Interpreter','latex','FontSize',16)
        saveas(gcf,'ZExample3C.eps','epsc')
    elseif saveplots == 1 && Ti == 4 && runs == runstosave
        legend off
        ylabel('$\log_{10}\mathrm{MSE}(2)$','Interpreter','latex','FontSize',16)
        saveas(gcf,'ZExample3D.eps','epsc')
    elseif saveplots == 1 && Ti == 5 && runs == runstosave
        legend off
        ylabel('$\log_{10}\mathrm{MSE}(4)$','Interpreter','latex','FontSize',16)
        saveas(gcf,'ZExample3E.eps','epsc')
    elseif saveplots == 1 && Ti == 6 && runs == runstosave
        legend off
        ylabel('$\log_{10}\mathrm{MSE}(6)$','Interpreter','latex','FontSize',16)
        saveas(gcf,'ZExample3F.eps','epsc')
    end
end
end
